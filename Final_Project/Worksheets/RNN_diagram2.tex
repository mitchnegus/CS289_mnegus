...
\node (x_p) [forwardfn, align=center, right of =blank] {$x_{1}$ \\ \footnotesize$[1\times1]$};
\node (x_c) [forwardfn, align=center, right of =x_p,xshift=5cm] {$x_{2}$ \\ \footnotesize$[1\times1]$};
\node (x_f) [forwardfn, align=center, right of =x_c,xshift=5cm] {$x_{3}$ \\ \footnotesize$[1\times1]$};
\node (V_p) [forwardfn, align=center, below of =blank,left of =x_p, xshift=0.5cm, yshift=2.5cm] {$V$ \\ \footnotesize$[200\times1]$};
\node (V_c) [forwardfn, align=center, below of =blank,left of =x_c, xshift=0.5cm, yshift=2.5cm] {$V$ \\ \footnotesize$[10\times1]$};
\node (V_f) [forwardfn, align=center, below of =blank,left of =x_f, xshift=0.5cm, yshift=2.5cm] {$V$ \\ \footnotesize$[10\times1]$};

\node (ReLU_p) [forwardfn, align=center, below of =x_p, yshift=-1cm] {$h_{1} = \ReLU(Vx_{t-1})$ \\ \footnotesize$[10\times1]$};
\node (ReLU_c) [forwardfn, align=center, below of =x_c, yshift=-1cm] {$h_{2} = \ReLU(Vx_{t})$ \\ \footnotesize$[10\times1]$};
\node (ReLU_f) [forwardfn, align=center, below of =x_f, yshift=-1cm] {$h_{3} = \ReLU(Vx_{t+1})$ \\ \footnotesize$[10\times1]$};

\node (z_p) [forwardfn, align=center, below of =ReLU_p,yshift=-2cm] {$z_{1} = s(Wh_{t+1})$ \\ \footnotesize$[3\times1]$};
\node (z_c) [forwardfn, align=center, below of =ReLU_c,yshift=-2cm] {$z_{2} = s(Wh_{t+1})$ \\ \footnotesize$[3\times1]$};
\node (z_f) [forwardfn, align=center, below of =ReLU_f,yshift=-2cm] {$z_{3}  = s(Wh_{t+1})$ \\ \footnotesize$[3\times1]$};


\node (W_p) [forwardfn, align=center, below of =ReLU_p, xshift=-2.5cm] {$W$\\ \footnotesize$[3 \times 200]$};
\node (W_c) [forwardfn, align=center, below of =ReLU_c, xshift=-2.5cm] {$W$\\ \footnotesize$[3 \times 200]$};
\node (W_f) [forwardfn, align=center, below of =ReLU_f, xshift=-2.5cm] {$W$\\ \footnotesize$[3 \times 200]$};

\node (loss_p) [forwardfn, align=center, below of =z_p] {$ L(z) = -\sum_{j=1}^{3}{y_j \ln z_{1,j} + (1-y_j) \ln(1-z_{1,j})} $\\\footnotesize $[1\times1]$};
\node (loss_c) [forwardfn, align=center, below of =z_c] {$ L(z) = -\sum_{j=1}^{3}{y_j \ln z_{2,j} + (1-y_j) \ln(1-z_{2,j})} $\\\footnotesize $[1\times1]$};
\node (loss_f) [forwardfn, align=center, below of =z_f] {$ L(z) = -\sum_{j=1}^{3}{y_j \ln z_{3,j} + (1-y_j) \ln(1-z_{3,j})} $\\\footnotesize $[1\times1]$};
...
\draw [arrow] (ReLU_p) -- (z_p);
\draw [arrow] (ReLU_c) -- (z_c);
\draw [arrow] (ReLU_f) -- (z_f);
\draw [arrow] (W_p) -- (z_p);
\draw [arrow] (W_c) -- (z_c);
\draw [arrow] (W_f) -- (z_f);

\draw [arrow] (z_p) -- (loss_p);
\draw [arrow] (z_c) -- (loss_c);
\draw [arrow] (z_f) -- (loss_f);
